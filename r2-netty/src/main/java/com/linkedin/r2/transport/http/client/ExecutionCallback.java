 ...
 * @version $Revision: $
 */
public class ExecutionCallback implements TransportCallback<StreamResponse>
{
   ...
   */
  public ExecutionCallback(ExecutorService executor, TransportCallback<StreamResponse> callback)
  {
    _executor = executor;
