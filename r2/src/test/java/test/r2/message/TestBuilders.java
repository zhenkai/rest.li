...
public class TestBuilders
{
  ...
  {
    final RestRequest req = new RestRequestBuilder(URI.create("src/test/resources/test"))
  ...
  {
    final Request req = new RestRequestBuilder(URI.create("src/test/resources/test"))
            .setEntity(new byte[] {1,2,3,4})
            .setHeader("k1", "v1")
            .setMethod(RestMethod.PUT)
            .build()
  ...
  {
    final RestMessage req = new RestRequestBuilder(URI.create("src/test/resources/test"))
            .setEntity(new byte[] {1,2,3,4})
            .setHeader("k1", "v1")
            .setMethod(RestMethod.PUT)
            .build()
    ...
    final RestRequest restReq = (RestRequest)req;
    Assert.assertEquals(RestMethod.PUT, restReq.getMethod());
    Assert.assertEquals(URI.create("src/test/resources/test"), restReq.getURI());
  }

  @Test
  public void testChainBuildRestRequestFromMessageBuilder()
  {
    final MessageBuilder<?> builder = new RestRequestBuilder(URI.create("src/test/resources/test"))
            .setEntity(new byte[] {1,2,3,4})
            .setHeader("k1", "v1")
            .setMethod(RestMethod.PUT)
            .build()
