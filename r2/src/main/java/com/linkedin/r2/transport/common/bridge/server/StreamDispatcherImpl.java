 ...
 * @author Zhenkai Zhu
 */
/* package private */ final class StreamDispatcherImpl implements StreamDispatcher
{
  private final Map<URI, StreamRequestHandler> _streamHandlers;

  /* package private */ StreamDispatcherImpl(Map<URI, StreamRequestHandler> streamHandlers)
  {
