...
/**
 * Reader is an Observer {@link com.linkedin.r2.message.entitystream.Observer} that has the extended ability to read data
 * and drive and control the data flow of an EntityStream {@link com.linkedin.r2.message.entitystream.EntityStream}
 *
 * @author Zhenkai Zhu
 */
